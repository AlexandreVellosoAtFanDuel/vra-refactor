...
public enum ConfigurationType {
    ...
    NEW_MAPPER_ALLOWED_PROVIDER_IDS("new.mapper.allowed.adapter.provider.ids"),
    ...
    CSS_PATH("css.path"),
    CSS_DIFF("css.diff"),
    PROVIDER_EVENT_NAME_SEPARATOR("adapter.provider.event.name.separator"),
    ...
    PROVIDER_SERVICE_COUNTRYCODE_MAPPING("adapter.provider.service.countrycode.mapping"),
    PROVIDER_SERVICE_VENUE_MAPPING("adapter.provider.service.venue.mapping"),
    ...
    PROVIDER_PRIORITY_LIST("adapter.provider.priority.list"),
    PROVIDER_IGNORE_EVENT_NAME_TOKENS("adapter.provider.ignore.event.name.tokens"),
    PROVIDER_WATCH_AND_BET_VENUES("adapter.provider.watch.and.bet.racecources"),
    PROVIDER_DASH_SUPPORT_VENUES("adapter.provider.dash.support.racecourses"),
    PROVIDER_DASH_SUPPORT_SPORTTYPES("adapter.provider.dash.support.sport.types"),
    ...
    PROVIDER_PARTICIPANT_SUPPORTED("adapter.provider.participant.supported"),
    PROVIDER_PARTICIPANT_MIN_MATCH("adapter.provider.participant.min.match"),
    PROVIDER_PARTICIPANT_ALLOWED_MARKET_TYPES("adapter.provider.participant.allowed.market.types"),
    ...
    BRANDS_GROUPED_BY_COMMON_PROVIDER_CREDS("brands.grouped.by.common.adapter.provider.creds"),
    ...
    BLOCKED_APPKEYS_FOR_PROVIDER("blocked.appkeys.for.adapter.provider"),
