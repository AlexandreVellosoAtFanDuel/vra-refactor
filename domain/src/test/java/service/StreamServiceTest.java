...
import com.betfair.video.domain.dto.entity.ProviderEventKey;
...
import com.betfair.video.domain.dto.entity.ScheduleItemMapping;
import com.betfair.video.domain.dto.entity.ScheduleItemMappingKey;
...
import com.betfair.video.domain.mapper.VideoStreamInfoMapper;
...
import static com.betfair.video.domain.exception.VideoException.ErrorCodeEnum.INVALID_INPUT;
import static com.betfair.video.domain.exception.VideoException.ErrorCodeEnum.STREAM_NOT_FOUND;
...
class StreamServiceTest {
    ...
    @Test
    @DisplayName("Should fail if no adapter.provider exist for video type")
    ...
    @Test
    @DisplayName("Should fail if no adapter.provider was found")
    ...
    @Test
    @DisplayName("Should fail if adapter.provider is not enabled")
