...
import com.betfair.video.api.output.adapter.provider.BetradarV2Adapter;
import com.betfair.video.api.output.client.BetRadarV2Client;
import com.betfair.video.api.output.dto.betradarv2.AudioVisualEventDto;
import com.betfair.video.api.output.dto.betradarv2.BaseDto;
import com.betfair.video.api.output.dto.betradarv2.ContentDto;
import com.betfair.video.api.output.dto.betradarv2.StreamDto;
...
class BetradarV2AdapterTest {
    ...
    @Mock
    IMap<String, List<AudioVisualEventDto>> cache;
    ...
    void testStreamDetailsHappyPath() {
        ...
        when(cache.get(anyString())).thenReturn(Collections.emptyList());
    ...
    void testStreamDetailsEventNotFound() {
        ...
        when(scheduleItem.betfairSportsType()).thenReturn(1);
        ...
        when(cache.get(anyString())).thenReturn(Collections.singletonList(eventDto));
