package com.betfair.video.api.architecture;
...
class ArchitectureTest {
    ...
    void infraAdaptersShouldImplementDomainPorts() {
        ArchRule rule = classes()
                .that().resideInAPackage("..infra.output.adapter..")
    ...
    @Test
    @DisplayName("Controllers should reside in infra input package")
    void controllersShouldResideInInfraInputPackage() {
        ArchRule rule = classes()
                .that().areAnnotatedWith("org.springframework.web.bind.annotation.RestController")
                .or().haveSimpleNameEndingWith("Controller")
                .should().resideInAPackage("..infra.input..");
